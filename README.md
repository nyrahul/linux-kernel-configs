...
# BPF/eBPF Support
| Distro | Arch | Kernel | CONFIG_BPF | [CGROUP_BPF](## "Support for eBPF programs attached to cgroups.") |
|:-------:|:-------:|:-------:|:-------:|:-------:|
...
| [CentOS Linux 7 (Core)](./CentOS%20Linux%207%20(Core)/3.10.0-1127.el7.x86_64) | x86_64 | 3.10.0 | :heavy_check_mark: | :x: |
