...
# Linux/x86 5.10.134-16.1.al8.x86_64 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="gcc (GCC) 10.2.1 20200825 (Alibaba 10.2.1-3.5 2.32)"
CONFIG_CC_IS_GCC=y
...
CONFIG_SCHED_SLI=y
CONFIG_RICH_CONTAINER=y
# CONFIG_RICH_CONTAINER_CG_SWITCH is not set
# CONFIG_MAX_PID_PER_NS is not set
...
# CONFIG_MICROCODE_HYGON is not set
...
CONFIG_LIVEPATCH=y
# CONFIG_LIVEPATCH_PER_TASK_MODEL is not set
CONFIG_LIVEPATCH_STOP_MACHINE_MODEL=y
...
CONFIG_CK_KABI_RESERVE=y
CONFIG_CK_KABI_SIZE_ALIGN_CHECKS=y
CONFIG_FREEZER=y
...
CONFIG_RECLAIM_COLDPGS=m
CONFIG_ASYNC_FORK=y
CONFIG_PAGE_PREZERO=y
CONFIG_TEXT_UNEVICTABLE=y
CONFIG_PAGECACHE_LIMIT=y
CONFIG_PGTABLE_BIND=y
CONFIG_LRU_GEN=y
...
CONFIG_TCP_MD5SIG=y
CONFIG_TCP_INIT_CWND_PROC=y
CONFIG_TCP_SYNACK_TIMEOUT_PROC=y
CONFIG_TCP_RT=y
CONFIG_TCP_RT_MODULE=m
CONFIG_ICMP_PINGTRACE=y
CONFIG_IPV6=y
...
# CONFIG_SATA_ZHAOXIN is not set
...
# CONFIG_SERIO_PHYTIUM_PS2 is not set
...
# CONFIG_I2C_PHYTIUM_PLATFORM is not set
CONFIG_I2C_SIMTEC=m
...
# CONFIG_SENSORS_PHYTIUM is not set
...
# CONFIG_DRM_VERISILICON is not set
CONFIG_DRM_INSPUR=m
...
CONFIG_LSM="integrity,selinux,smack,tomoyo,apparmor"
...
# CONFIG_CRYPTO_USER_API_AKCIPHER is not set
...
CONFIG_SCHED_INFO=y
CONFIG_SCHEDSTATS=y
# CONFIG_SCHEDSTATS_HOST is not set
CONFIG_SCHED_ACPU=y
