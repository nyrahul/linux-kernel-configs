...
# Linux/x86 6.6.84 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="gcc (Deepin 12.3.0-17deepin8) 12.3.0"
CONFIG_CC_IS_GCC=y
...
CONFIG_LOCALVERSION="-amd64-desktop-hwe"
...
# CONFIG_DEEPIN_KABI_RESERVE is not set
...
CONFIG_MGBE=m
# CONFIG_MGBE_OPTM_WITH_LPAGE is not set
...
# CONFIG_PHYTIUM_I3C_MASTER is not set
CONFIG_SPI=y
...
#
# CONFIG_VIDEO_PHYTIUM_JPEG is not set
...
CONFIG_DRM_ARISE=m
CONFIG_DRM_HYPERV=m
# CONFIG_DRM_CIX_EDP_PANEL is not set
...
# CONFIG_SND_HDA_PHYTIUM is not set
...
#
# ASoC support for Cixtech
#

#
# ASoC options for Cixtech CPUs:
#
# end of ASoC support for Cixtech
...
#
# Clock support for Cixtech
#

#
# Clock options for Cixtech CPUs:
#
# end of Clock support for Cixtech
...
# CONFIG_TIMER_SKY1_GPT is not set
